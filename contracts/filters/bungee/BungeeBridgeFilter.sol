// contracts/BungeeBridgeFilter.sol
...
/// @title A simple implementation of filter for Bungee Exchange's Bridge
/// @author Teahouse Finance
contract BungeeBridgeFilter is BaseFilter {
    ...
    */
    ...
    function outboundTransferTo(UserRequest calldata _userRequest) external view returns (bytes4) {
        if (_userRequest.receiverAddress != msg.sender) {
