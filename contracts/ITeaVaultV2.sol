...
interface ITeaVaultV2 {
    ...
    function deposit1155Batch(address _token, uint256[] calldata _tokenIds, uint256[] calldata _amounts) external;
    function withdraw1155Batch(address _recipient, address _token, uint256[] calldata _tokenIds, uint256[] calldata _amounts) external;
